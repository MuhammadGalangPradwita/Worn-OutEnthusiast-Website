    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('participant.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select name="gender" id="gender" required
                            ...
                            <option value="Laki-laki" {{ old('gender') == 'Laki-laki' ? 'selected' : '' }} class="bg-denim-800">Laki-laki</option>
                            <option value="Perempuan" {{ old('gender') == 'Perempuan' ? 'selected' : '' }} class="bg-denim-800">Perempuan</option>
                        </select>
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    <div>
                        <label for="instagram" class="block text-sm text-denim-300 mb-2">Username Instagram (Tidak di-private) *</label>
            ...
            <div class="space-y-6 pt-4">
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label for="denim_cut" class="block text-sm text-denim-300 mb-2">Jenis Cuttingan Celana *</label>
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    <div>
                        <label for="denim_weight" class="block text-sm text-denim-300 mb-2">Oz / Ketebalan Celana Denim *</label>
                        <input type="text" name="denim_weight" id="denim_weight" value="{{ old('denim_weight') }}" required
                            class="w-full bg-denim-700/30 border border-denim-600/30 rounded-lg px-4 py-3 text-white text-sm placeholder-denim-500 focus:outline-none focus:border-denim-400 transition-colors"
                            placeholder="Contoh: 14oz, 18oz, dll">
                        @error('denim_weight') <p class="text-red-400 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label for="gdrive_link" class="block text-sm text-denim-300 mb-2">Link Google Drive Portofolio/Bukti *</label>
                ...
                {{-- Photos --}}
                <div class="space-y-4">
                    <p class="text-sm border-l-4 border-yellow-500/50 bg-yellow-500/10 p-3 text-yellow-200/90 rounded-r">
                        <strong>Perhatian:</strong> Dalam foto celana denim (Tampak Depan & Belakang) wajib menyertakan Tanggal, Bulan, dan Tahun saat foto diambil.
                    </p>
                    
                    <div>
                        <label for="photo_front" class="block text-sm text-denim-300 mb-2">Foto Celana Denim Tampak Depan *</label>
                    ...
                    <div>
                        <label for="photo_back" class="block text-sm text-denim-300 mb-2">Foto Celana Denim Tampak Belakang *</label>
            ...
            <div class="space-y-6 pt-4">
                ...
                <div class="bg-navy-900/40 border border-denim-600/30 rounded-2xl p-6 relative overflow-hidden group">
                    {{-- Decorative Blur --}}
                    <div class="absolute -right-8 -top-8 w-24 h-24 bg-denim-500/10 rounded-full blur-2xl group-hover:bg-denim-500/20 transition-colors duration-500"></div>
                    
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                        <div class="space-y-4">
                            <div class="flex items-center gap-3">
                                <div class="bg-denim-500/20 px-3 py-1 rounded-full border border-denim-500/30">
                                    <span class="text-xs font-bold text-denim-300 uppercase tracking-widest">Blue by BCA</span>
                                </div>
                            ...
                            <div x-data="{ 
                                ...
                                <span class="text-2xl md:text-3xl font-mono font-bold text-white tracking-widest" x-text="content"></span>
                                <button type="button" @click="copy()" class="p-2 rounded-lg bg-denim-700/30 border border-denim-600/30 text-denim-400 hover:text-white hover:bg-denim-600/50 transition-all flex items-center gap-2 group/copy">
                                    <svg x-show="!copied" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3" />
                                    </svg>
                                    <svg x-show="copied" class="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-denim-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="hidden md:block">
                            <div class="w-16 h-16 bg-denim-500/10 rounded-2xl flex items-center justify-center border border-denim-500/20">
                                <svg class="w-8 h-8 text-denim-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
