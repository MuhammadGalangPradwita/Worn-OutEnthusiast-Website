...
@section('content')
    <div class="max-w-2xl">
        <div class="flex items-center gap-4 mb-6">
            ...
            <h2 class="font-display font-bold text-xl text-white">Edit Category</h2>
        </div>
        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full bg-denim-700/30 border border-denim-600/30 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-denim-400 transition-colors resize-none">{{ old('description', $category->description) }}</textarea>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="prize" value="{{ old('prize', $category->prize) }}" min="0"
            ...
            <div>
                ...
                @if($category->image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $category->image) }}" alt="" class="w-32 h-20 object-cover rounded-lg">
                    </div>
                @endif
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button type="submit"
                    class="px-6 py-2.5 bg-denim-500 hover:bg-denim-400 text-white text-sm font-medium rounded-lg transition-colors">Update
                    Category</button>
            </div>
        </form>
    </div>
